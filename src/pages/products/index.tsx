      ...
      <Container className="py-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
            {total > 0 ? `${total} vehicles found` : 'Search or filter to find your car'}
          </p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            placeholder='Try "Toyota SUV automatic under $30,000" or "electric sedan 2022"'
              ...
              <FilterGroup label="Type">
                {TYPES.map((t) => (
                  <Chip
                    key={t}
                    label={t}
                    active={filters.typeList.includes(t)}
                    onClick={() => handleFilterChange('typeList', toggleArray(filters.typeList, t))}
                  />
                ))}
              </FilterGroup>
        ...
        {loading && vehicles.length === 0 ? (
          ...
          <div className="rounded-xl border border-dashed border-zinc-300 p-16 text-center dark:border-zinc-700">
            <p className="text-zinc-500 dark:text-zinc-400">No vehicles found.</p>
